...
export function seedState() {
  ...
  const here = {
    ...
    status: 'current',
    horizon: 'unknown',
    notes: 'Rate the place you\'re in today first. Without a baseline, every other place is just a feeling.',
    createdAt: new Date().toISOString(),
    seeded: true,
  };
  ...
  return {
    ...
    notes: [{
      id: noteId,
      date: today(),
      title: 'What I actually want is roots',
      kind: 'observation',
      body:
        'The thing I carry the most stress about isn\'t which network to join — it\'s whether we can find a place to '
        + 'put down roots. Somewhere with real community, where my family can grow well, and where we could still be '
        + 'in ten years. Every opportunity has to be weighed against that, not the other way around.',
      convictionIds: [],
      contextIds: [],
      source: '',
      seeded: true,
    ...
    actions: [
      {
        id: uid(),
        title: 'Ask her what she would need to feel rooted somewhere',
        detail: 'Her list, in her words. Write it down before I react to any of it.',
        due: '',
        done: false,
        convictionIds: [],
        contextIds: [],
